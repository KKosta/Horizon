...
$sendingAccountUsername     = 'kolev1993@gmail.com';
$sendingAccountPassword     = 'walla@gmail';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'team@hackhorizon.com'; // REQUIRED value.
$recipientName              = 'Kostadin Kolev';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Your Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Horizon';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Asia/Hong_Kong';         // OPTIONAL, but some servers require this to be set. 
